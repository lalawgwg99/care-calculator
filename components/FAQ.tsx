...
const FAQ_ITEMS = [
  {
    ...
    a: "長照是政府針對失能、失智者提供的照顧服務制度。長照 3.0 自 2026 年起分階段實施，1 月與 7 月分別調整部分服務對象及智慧輔具等措施。實際資格與補助仍須由照管中心依 CMS 等級、身分與服務項目評估。",
  },
  {
    q: "我要怎麼申請長照服務？",
  ...
  {
    q: "聘外籍看護還能申請長照補助嗎？",
    a: "可以。照顧及專業服務原則上使用原核定額度的 30%，不得使用一般居家服務；自 2025 年 9 月起可在原核定額度內使用日間照顧或家庭托顧。交通、輔具與無障礙評估，以及外籍看護休假時的喘息服務，仍可依資格申請。",
  },
  {
    q: "長照補助的「四包錢」是什麼意思？",
    a: "政府將長照補助分為四大類：❶ 照顧及專業服務、❷ 交通接送、❸ 輔具及居家無障礙改善、❹ 喘息服務。交通依居住地分為每月 1,680～2,400 元；輔具自 2026 年 7 月起分為每 3 年 4 萬元與 6 萬元兩組，實際資格由照管中心核定。",
  },
  {
    q: "家裡兄弟姊妹很多，費用怎麼分攤？",
